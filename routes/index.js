...
router.get('/', function(req, res, next) {
  ...
  res.render('index', {
    ...
    a0img: '/f/' + obj[0].imgFull,
    a1img: '/f/' + obj[1].imgFull,
    a2img: '/f/' + obj[2].imgFull,
    a3img: '/f/' + obj[3].imgFull,
    a4img: '/f/' + obj[4].imgFull,
    a5img: '/f/' + obj[5].imgFull,
    a6img: '/f/' + obj[6].imgFull,
    a7img: '/f/' + obj[7].imgFull,
    a8img: '/f/' + obj[8].imgFull,
    a9img: '/f/' + obj[9].imgFull
  });
});
